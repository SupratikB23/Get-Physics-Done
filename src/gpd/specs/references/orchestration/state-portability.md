...
- **Task level**: bounded execution state, active resume pointer, interrupted agents, and live review gates (the current raw envelope still exposes compatibility labels such as `current_execution` and `execution_resume_file`)
