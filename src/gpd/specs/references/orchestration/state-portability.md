...
- **Task level**: bounded execution state, active resume pointer, interrupted agents, and live review gates (the current raw envelope still exposes compatibility labels such as `current_execution`, `execution_resume_file`, and `segment_candidates`)
...
Current public behavior therefore distinguishes canonical continuation authority, continuity mirrors, and the derived execution head:
